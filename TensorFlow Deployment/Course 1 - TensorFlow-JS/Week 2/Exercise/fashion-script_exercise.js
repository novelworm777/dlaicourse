...
function getModel() {
    ...
    model.add(tf.layers.conv2d({inputShape: [28, 28, 1], kernelSize: 3, filters: 7, activation: 'relu'}));
	model.add(tf.layers.maxPooling2d({poolSize: [2, 2]}));
	model.add(tf.layers.conv2d({filters: 14, kernelSize: 3, activation: 'relu'}));
	model.add(tf.layers.maxPooling2d({poolSize: [2, 2]}));
